[
  {
    ...
    categoria: "terror",
    descricao:
      "Nesta sequência, um grupo de jovens decide dar vida nova a uma cidade fantasma no Texas, mas acaba se deparando com Leatherface, o famoso ",
  ...
  },
  {
    ...
    categoria: "terror",
    descricao:
      "Vinte e cinco anos após uma série de crimes brutais chocar a tranquila Woodsboro, um novo assassino se apropria da máscara de Ghostface ",
  ...
  },
  {
    ...
    categoria: "romance",
    descricao:
      "Em busca de imortalidade, o rei Luís XIV rouba a força vital de uma sereia, mas tudo se complica quando sua filha ilegítima cria laços ",
  ...
  },
  {
    ...
    categoria: "comedia",
    descricao:
      "Uma mãe solteira resolve se mudar para uma pequena cidade do interior com seus filhos, e acaba descobrindo uma conexão com os Caça-Fanta",
  ...
  },
  {
    ...
    categoria: "drama",
    descricao:
      "Em um futuro distante, planetas são comandados por casas nobres que fazem parte de um império feudal intergalático. Paul Atreides é um jovem homem cuja família toma controle do planeta desert",
  ...
  },
  {
    ...
    categoria: "acao",
    descricao: "quarta parcela da franquia Matrix. Trama ainda desconhecid.",
  ...
  },
  {
    ...
    categoria: "drama",
    descricao:
      "Após cumprir pena por um crime violento, Ruth volta ao convívio na sociedade, que se recusa a perdoar seu passado. Discriminada no lugar ",
